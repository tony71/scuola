...
try {
	...
	*******************************************************/
	...
	$sql = "select * from vista_studenti_cv where matricola_studente='$matricola' and anno_scolastico=calcola_anno_scolastico()";
	$stm = $db->query($sql);
